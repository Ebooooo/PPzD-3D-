...
public class ObjectUsage : MonoBehaviour {
    ...
    [Header("Pickaxe related")]
    public AudioClip swingAudio;
    public AudioClip rockHitAudio;
    ...
    void Update ()
    {
        ...
        if(Input.GetMouseButtonDown(0))
        {
            ...
            if (inventory.selected == 2)
            {
                ...
                PlayPickaxeAudioClip(swingAudio);
                ...
                if (Physics.Raycast(ray, out hit, 4f))
                {
                    ...
                    PlayPickaxeAudioClip(rockHitAudio);
                    ...
                    if (hit.transform.tag == "AI")
                    {
                        ...
                        AI.PathFinder = false;
                        AI.DetectionRange += 5f;
                        PlayPickaxeAudioClip(enemyHitAudio);
                    }
                }
            }
        }
    ...
    private void PlayPickaxeAudioClip(AudioClip clip)
    {
        pickaxeAudioSource.Stop();
        pickaxeAudioSource.clip = clip;
